    ...
    extends EcomDev_PHPUnit_Test_Case_Controller
{
    ...
    protected function setUp()
    {
        ...
        if ($mockedHelperMethods) {
            ...
            $this->replaceByMock('helper', 'ecomdev_checkitout/data', $this->helperMock);
        }
    }
    ...
    protected function assertLayoutStructureForActivedFunctionality()
    {
        ...
        $this->assertLayoutBlockActionInvoked('checkout.onepage.payment', 'setTemplate', array('ecomdev/checkitout/payment.phtml'));
     ...
     * @test
     */
    public function checkSaveAddresses($dataSetName, $checkoutMethod, array $billingData,
        array $shippingData,  array $productIds, array $requestData)
    {
        // Module functionality is activated
        $this->helperMethodStub($this->any(), 'isActive', true);
