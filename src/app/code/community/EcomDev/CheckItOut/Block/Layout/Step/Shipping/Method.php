...
/**
 * Shipping method selection step wrapper
 *
 */
class EcomDev_CheckItOut_Block_Layout_Step_Shipping_Method extends EcomDev_CheckItOut_Block_Layout_Step_Abstract
{
    /**
